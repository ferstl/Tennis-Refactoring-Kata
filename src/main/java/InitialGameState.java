...
final class InitialGameState {
    ...
    static final FlipableGameState ADVANTAGE_PLAYER1 = new AdvantagePlayer1();

    static final FlipableGameState ADVANTAGE_PLAYER2 = new AdvantagePlayer2();

    static final FlipableGameState WIN_PLAYER1 = new WinPlayer1();

    static final FlipableGameState WIN_PLAYER2 = new WinPlayer2();

    static final FlipableGameState DEUCE = new Deuce();

    static final GameState INITIAL_STATE = computeInitialState();
    
    interface FlipableGameState extends GameState {
    ...
    static final class GenericGameState implements FlipableGameState {
    ...
    static final class All implements FlipableGameState {
    ...
    static final class Deuce implements FlipableGameState {
    ...
    static abstract class Advantage implements FlipableGameState {
    ...
    static final class AdvantagePlayer1 extends Advantage {
    ...
    static final class AdvantagePlayer2 extends Advantage {
    ...
    static abstract class WonGame implements FlipableGameState {
    ...
    static final class WinPlayer1 extends WonGame {
    ...
    static final class WinPlayer2 extends WonGame {
